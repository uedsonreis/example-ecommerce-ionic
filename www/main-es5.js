...
/* harmony import */ var _resolver_user_resolver_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resolver/user-resolver.service */ "./src/app/resolver/user-resolver.service.ts");
...
var routes = [
    {
        ...
        path: 'product',
        loadChildren: function () { return Promise.all(/*! import() | product-product-module */[__webpack_require__.e("common"), __webpack_require__.e("product-product-module")]).then(__webpack_require__.bind(null, /*! ./product/product.module */ "./src/app/product/product.module.ts")).then(function (m) { return m.ProductPageModule; }); }
    }, {
        path: 'list',
        resolve: { token: _resolver_user_resolver_service__WEBPACK_IMPORTED_MODULE_3__["UserResolverService"] },
        ...
        path: 'sales-order',
        loadChildren: function () { return __webpack_require__.e(/*! import() | sales-order-sales-order-module */ "sales-order-sales-order-module").then(__webpack_require__.bind(null, /*! ./sales-order/sales-order.module */ "./src/app/sales-order/sales-order.module.ts")).then(function (m) { return m.SalesOrderPageModule; }); }
    }, {
        path: 'login',
...
/***/ "./src/app/resolver/user-resolver.service.ts":
/*!***************************************************!*\
  !*** ./src/app/resolver/user-resolver.service.ts ***!
  \***************************************************/
...
var UserResolverService = /** @class */ (function () {
    function UserResolverService(dataService) {
    ...
    UserResolverService.prototype.resolve = function (route) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataService.getToken()];
                    case 1: 
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.login = function (username, token) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.set(UserService_1.LOGGED, username)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.storage.set(UserService_1.TOKEN, token)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserService.prototype.getToken = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.storage.get(UserService_1.TOKEN)];
            });
        });
    };
    UserService.prototype.getLoggedUser = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.storage.get(UserService_1.LOGGED)];
            });
        });
    };
    UserService.prototype.logout = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.remove(UserService_1.LOGGED)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.storage.remove(UserService_1.TOKEN)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
...
module.exports = __webpack_require__(/*! /Users/uedsonreis/Documents/Projetos/faculdades/example-ecommerce-ionic/src/main.ts */"./src/main.ts");
