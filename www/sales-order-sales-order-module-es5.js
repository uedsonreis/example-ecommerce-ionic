...
var SalesOrderPage = /** @class */ (function () {
    function SalesOrderPage(router) {
        this.router = router;
    }
    SalesOrderPage.prototype.ngOnInit = function () {
        this.salesOrder = this.router.getCurrentNavigation().extras.state.salesOrder;
        var total = 0.0;
        this.salesOrder.items.forEach(function (item) {
            total += item.price * item.amount;
        });
        this.total = total;
    };
    SalesOrderPage.ctorParameters = function () { return [
