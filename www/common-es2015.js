...
let CartService = CartService_1 = class CartService {
    ...
    get() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const value = yield this.storage.get(CartService_1.CART_ID);
    ...
    add(item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const items = yield this.get();
            const itemSaved = this.getItem(items, item.product);
            if (itemSaved)
    ...
    clear() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.storage.remove(CartService_1.CART_ID);
        });
    }
    getItem(items, product) {
...
const BASE_URL = "http://example-ecommerce.herokuapp.com/";
