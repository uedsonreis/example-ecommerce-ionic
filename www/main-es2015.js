...
const routes = [
    {
        ...
        path: 'product',
        loadChildren: () => Promise.all(/*! import() | product-product-module */[__webpack_require__.e("common"), __webpack_require__.e("product-product-module")]).then(__webpack_require__.bind(null, /*! ./product/product.module */ "./src/app/product/product.module.ts")).then(m => m.ProductPageModule)
    }, {
        path: 'list',
        ...
        path: 'sales-order',
        loadChildren: () => __webpack_require__.e(/*! import() | sales-order-sales-order-module */ "sales-order-sales-order-module").then(__webpack_require__.bind(null, /*! ./sales-order/sales-order.module */ "./src/app/sales-order/sales-order.module.ts")).then(m => m.SalesOrderPageModule)
    }, {
        path: 'login',
...
let UserResolverService = class UserResolverService {
    ...
    resolve(route) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return yield this.dataService.getToken();
        });
    }
};
...
let UserService = UserService_1 = class UserService {
    ...
    login(username, token) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.storage.set(UserService_1.LOGGED, username);
            yield this.storage.set(UserService_1.TOKEN, token);
        });
    }
    getToken() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return this.storage.get(UserService_1.TOKEN);
        });
    }
    getLoggedUser() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return this.storage.get(UserService_1.LOGGED);
        });
    }
    logout() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.storage.remove(UserService_1.LOGGED);
            yield this.storage.remove(UserService_1.TOKEN);
        });
    }
};
