...
var CartPage = /** @class */ (function () {
    function CartPage(router, route, cartService, http) {
        this.router = router;
        this.route = route;
    ...
    CartPage.prototype.invoice = function () {
        var _this = this;
        if (this.isEmpty())
            return;
        var options = {
    ...
    CartPage.prototype.isEmpty = function () {
        return (this.items.length <= 0);
    };
    CartPage.prototype.delete = function (item) {
        var _this = this;
        this.cartService.remove(item).then(function (items) {
            _this.items = items;
        });
    };
