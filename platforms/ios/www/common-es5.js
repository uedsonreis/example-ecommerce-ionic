...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.get = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get(CartService_1.CART_ID)];
                    case 1:
                        value = _a.sent();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        items = _a.sent();
                        itemSaved = this.getItem(items, item.product);
                        if (itemSaved)
                        ...
                        this.storage.set(CartService_1.CART_ID, JSON.stringify(items));
                        return [2 /*return*/];
                }
            });
        });
    ...
    CartService.prototype.clear = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.remove(CartService_1.CART_ID)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CartService.prototype.getItem = function (items, product) {
        return items.find(function (item) { return item.product.id === product.id; });
    };
    CartService.prototype.removeItem = function (items, item) {
        items.splice(items.indexOf(item), 1);
    };
    var CartService_1;
    CartService.CART_ID = "CART";
    CartService.ctorParameters = function () { return [
        { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"] }
    ]; };
    CartService = CartService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/*!********************************!*\
  !*** ./src/utils/constants.ts ***!
  \********************************/
/*! exports provided: BASE_URL, HttpCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var BASE_URL = "http://example-ecommerce.herokuapp.com/";
